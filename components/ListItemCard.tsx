...
import { deleteItem, Item, toggleItemCompleted } from "../redux/features/items/itemsSlice";
import { DeleteIcon } from "@chakra-ui/icons";
import { Box, IconButton, Checkbox, useBreakpointValue, useColorModeValue } from "@chakra-ui/react";
    ...
    >
      ...
      >
        ...
        <IconButton
          ...
          colorScheme="red"
          onClick={() =>
            item._id && customListName && dispatch(deleteItem(customListName, item._id))
          }
          icon={<DeleteIcon />}
        />
      </MotionFlex>
